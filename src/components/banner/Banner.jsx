        ...
        <div style={{backgroundImage: `url(${BannerImage})`}} className='w-full bg-cover bg-center px-4 py-36 rounded-xl'>
            <div className='text-white text-center'>
                ...
                <div className="sm:flex gap-2 justify-center space-y-2 sm:space-y-0">
                    <button className='bg-[#4ade80] px-10 py-4 rounded-full w-full sm:w-60'>Explore Now</button>
                    <button className='bg-[#4ade80] px-10 py-4 rounded-full w-full sm:w-60'>Our FeedBack</button>
                </div>
            </div>
        </div>
    );
